...
os.environ["HF_HUB_DISABLE_SYMLINKS_WARNING"] = "1"  # Avoid symlink warnings
...
# Setup PEFT configuration (adjusted for Gemma architecture)
peft_config = LoraConfig(
    r=64,
    lora_alpha=16,
    target_modules=["q_proj", "v_proj"],  # Simplified target modules for Gemma
    bias="none",
    task_type="SEQ_CLS"
)
